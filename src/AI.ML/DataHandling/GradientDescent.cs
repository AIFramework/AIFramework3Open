...
namespace AI.ML.DataHandling;

/// <summary>
/// Класс для хранения обучающей выборки для градиентного спуска
/// </summary>
[Serializable]
public class GradientDescentDataset
{
    ...
    /// <summary>
    /// Создает экземпляр GradientDescentDataset
    /// </summary>
    public GradientDescentDataset()
    {
    ...
    public GradientDescentDataset(List<Vector> xVector, List<Vector> yVector)
    {
        _X = xVector;
        _Y = yVector;
    }
...
public class GradientDescent
{
    ...
    /// Обучающая выборка
    /// </summary>
    public GradientDescentDataset GdDataset { get; set; }
    /// <summary>
    ...
    public GradientDescent(Vector param, Func<Vector, List<Vector>, List<Vector>, double> function, GradientDescentDataset gdd)
    {
        Itterations = 30;
        GdDataset = gdd;
        Function = function;
