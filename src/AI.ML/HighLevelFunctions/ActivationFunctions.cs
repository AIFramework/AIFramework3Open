...
/// <summary>
/// Векторные функции активации для <see cref="Vector"/> (высокий уровень).
/// Для слоёв нейросети и обратного распространения используйте реализации <c>IActivation</c> в <c>AI.ML.NeuralNetworks.Core.Activations</c> (в т.ч. каталоги Standard и Extended).
/// </summary>
