...
public class EllipticIntegral
{
    ...
    /// </summary>
    /// <param name="k">Значение</param>
    public static double CompleteComplementaryEllipticIntegral_I(double k)
    {
        double complementaryArg = k * k;
        complementaryArg = Math.Sqrt(1 - complementaryArg);
        return CompleteEllipticIntegral_I(complementaryArg);
    }
