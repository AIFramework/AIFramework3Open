...
public class ImageSimilarityMetrics
{
    ...
    public static double Dice(IAlgebraicStructure<double> alg_str_1, IAlgebraicStructure<double> alg_str_2, double threshold = 0.5)
    {
        ...
        {
            bool struct_1 = data1[i] >= threshold;
            bool struct_2 = data2[i] >= threshold;
