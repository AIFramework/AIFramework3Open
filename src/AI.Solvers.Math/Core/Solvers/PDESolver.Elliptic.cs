...
Для прямоугольника [0,a]×[0,b]:
  u(x,y) = Σ Σ A_mn·sin(mπx/a)·sin(nπy/a)
  
  где A_mn = 4/(ab·λ_mn)·∫∫ f(ξ,η)·sin(mπξ/a)·sin(nπη/b) dξ dη
      λ_mn = (mπ/a)² + (nπ/b)²

Для круга радиуса R:
  u(r,θ) = 1/(2π)·∫₀^(2π) ∫₀^R G(r,θ;ρ,φ)·f(ρ,φ)·ρ dρ dφ
  
  где G(r,θ;ρ,φ) = ln|r⃗ - r⃗'| - ln(R/ρ) - функция Грина

Свойство: Если f = 0, то u = 0 (уравнение Лапласа)";
