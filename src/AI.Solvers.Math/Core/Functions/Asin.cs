...
public class Asin : Expression
{
    ...
    public Asin(Expression argument) => Argument = argument;
    ...
    public override Expression Simplify()
    {
        ...
        if (arg is Constant c2 && System.Math.Abs(c2.Value) <= 1)
            return new Constant(System.Math.Asin(c2.Value));
    ...
    public override Expression Clone() => new Asin(Argument.Clone());
}
