using AI.LLM.API.LocalServer;
using AI.LLM.Core.Models.Common.Generation;
using AI.LLM.Services.Prompts.FewShot;

namespace AI.LLM.Clients.LocalServer;
...
public class LocalServerWithFewShot
{
    ...
    {
        if (BaseLLMServer == null)
            throw new InvalidOperationException("BaseLLMServer is not initialized. Set it before calling SendAsync.");
