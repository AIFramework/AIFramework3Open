...
{
    /// <summary>
    /// Максимальное время простоя между получением данных (по умолчанию 70 секунд)
    /// </summary>
    public TimeSpan IdleTimeout { get; set; } = TimeSpan.FromSeconds(70);
    ...
    /// <summary>
    /// Настройки по умолчанию (70 секунд)
    /// </summary>
