...
public static class HelpSystem
{
    ...
    private static string GetMainHelp()
    {
        ...
        sb.AppendLine();
        sb.AppendLine("⚗️ ФИЗИЧЕСКАЯ ХИМИЯ:");
    ...
    private static string GetPharmacokineticHelp()
    {
        ...
        sb.AppendLine();
        sb.AppendLine("1️⃣ ОДНОКАМЕРНАЯ МОДЕЛЬ - IV БОЛЮС:");
        ...
        sb.AppendLine();
        sb.AppendLine("2️⃣ НЕПРЕРЫВНАЯ ИНФУЗИЯ:");
        sb.AppendLine("   Команда:");
        ...
        sb.AppendLine();
        sb.AppendLine("3️⃣ ПЕРОРАЛЬНОЕ ВВЕДЕНИЕ:");
        sb.AppendLine("   Команда:");
        ...
        sb.AppendLine();
        sb.AppendLine("5️⃣ ОПРЕДЕЛЕНИЕ T½:");
        sb.AppendLine("   Команда:");
    ...
    private static string GetBloodGasHelp()
    {
        ...
        sb.AppendLine("📌 ДОСТУПНЫЕ РАСЧЁТЫ:");
        sb.AppendLine();
        sb.AppendLine("1️⃣ ПОЛНЫЙ АНАЛИЗ КОС:");
        sb.AppendLine("   Команда:");
        ...
        sb.AppendLine();
        sb.AppendLine("2️⃣ РАСЧЁТ БИКАРБОНАТА:");
        sb.AppendLine("   Команда:");
    ...
    private static string GetEnzymeKineticsHelp()
    {
        ...
        sb.AppendLine("📌 ДОСТУПНЫЕ РАСЧЁТЫ:");
        sb.AppendLine();
        sb.AppendLine("1️⃣ МИХАЭЛИС-МЕНТЕН:");
        sb.AppendLine("   Команда:");
        ...
        sb.AppendLine();
        sb.AppendLine("2️⃣ LINEWEAVER-BURK:");
        sb.AppendLine("   Команда:");
        ...
        sb.AppendLine();
        sb.AppendLine("3️⃣ КОНКУРЕНТНОЕ ИНГИБИРОВАНИЕ:");
        sb.AppendLine("   Команда:");
        ...
        sb.AppendLine();
        sb.AppendLine("4️⃣ НЕКОНКУРЕНТНОЕ ИНГИБИРОВАНИЕ:");
        sb.AppendLine("   Команда:");
        ...
        sb.AppendLine();
        sb.AppendLine("5️⃣ УДЕЛЬНАЯ АКТИВНОСТЬ:");
        sb.AppendLine("   Команда:");
    ...
    private static string GetBufferHelp()
    {
        ...
        sb.AppendLine("📌 ДОСТУПНЫЕ РАСЧЁТЫ:");
        sb.AppendLine();
        sb.AppendLine("1️⃣ HENDERSON-HASSELBALCH (pH БУФЕРА):");
        sb.AppendLine("   Команда:");
        ...
        sb.AppendLine();
        sb.AppendLine("2️⃣ БУФЕРНАЯ ЁМКОСТЬ (β):");
        sb.AppendLine("   Команда:");
    ...
    private static string GetTitrationHelp()
    {
        ...
        sb.AppendLine();
        sb.AppendLine("1️⃣ КРИВАЯ ТИТРОВАНИЯ:");
        sb.AppendLine("   Команда:");
    ...
    private static string GetSolubilityHelp()
    {
        ...
        sb.AppendLine("📌 ДОСТУПНЫЕ РАСЧЁТЫ:");
        sb.AppendLine();
        sb.AppendLine("1️⃣ РАСЧЁТ РАСТВОРИМОСТИ ИЗ Ksp:");
        sb.AppendLine("   Команда:");
        ...
        sb.AppendLine();
        sb.AppendLine("2️⃣ ОБЩИЙ ИОННЫЙ ЭФФЕКТ:");
        sb.AppendLine("   Команда:");
    ...
    private static string GetComplexHelp()
    {
        ...
        sb.AppendLine("📌 ДОСТУПНЫЕ РАСЧЁТЫ:");
        sb.AppendLine();
        sb.AppendLine("1️⃣ ОБРАЗОВАНИЕ КОМПЛЕКСА:");
        sb.AppendLine("   Команда:");
        ...
        sb.AppendLine();
        sb.AppendLine("2️⃣ СТУПЕНЧАТОЕ КОМПЛЕКСООБРАЗОВАНИЕ:");
        sb.AppendLine("   Команда:");
        ...
        sb.AppendLine();
        sb.AppendLine("3️⃣ ВЛИЯНИЕ pH НА КОМПЛЕКСООБРАЗОВАНИЕ (EDTA):");
        sb.AppendLine("   Команда:");
        ...
        sb.AppendLine();
        sb.AppendLine("4️⃣ ХЕЛАТНЫЙ ЭФФЕКТ:");
        sb.AppendLine("   Команда:");
    ...
    private static string GetKineticsHelp()
    {
        ...
        sb.AppendLine();
        sb.AppendLine("3️⃣ УРАВНЕНИЕ АРРЕНИУСА:");
        sb.AppendLine("   Команда:");
        ...
        sb.AppendLine();
        sb.AppendLine("4️⃣ ОПРЕДЕЛЕНИЕ ПОРЯДКА РЕАКЦИИ:");
        sb.AppendLine("   Команда:");
        ...
        sb.AppendLine();
        sb.AppendLine("5️⃣ ИНТЕГРИРОВАННЫЕ УРАВНЕНИЯ СКОРОСТИ:");
        sb.AppendLine("   Команда:");
    ...
    private static string GetSpectroscopyHelp()
    {
        ...
        sb.AppendLine();
        sb.AppendLine("5️⃣ АНАЛИЗ СМЕСИ (2 компонента):");
        sb.AppendLine("   Команда:");
        ...
        sb.AppendLine();
        sb.AppendLine("6️⃣ КАЛИБРОВОЧНАЯ КРИВАЯ:");
        sb.AppendLine("   Команда:");
