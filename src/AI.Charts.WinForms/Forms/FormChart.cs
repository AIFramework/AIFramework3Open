...
public partial class FormChart : Form
{
    ...
    public void VisualData(ChartData chartDatas)
    {
        ...
        for (int i = 0; i < chartDatas.Count; i++)
        {
            ...
            {
                case ChartType.Plot:
                    chartVisual1.AddPlot(chartDatas[i].DataX, chartDatas[i].DataY, chartDatas[i].DescriptionData.Name, chartDatas[i].ColorChart, 2);
                    break;
                case ChartType.Bar:
                    chartVisual1.AddBar(chartDatas[i].DataX, chartDatas[i].DataY, chartDatas[i].DescriptionData.Name, chartDatas[i].ColorChart);
                    break;
                case ChartType.Spline:
                    chartVisual1.AddPlot(chartDatas[i].DataX, chartDatas[i].DataY, chartDatas[i].DescriptionData.Name, chartDatas[i].ColorChart, 2, true);
                    break;
                case ChartType.Scatter:
                    chartVisual1.AddScatter(chartDatas[i].DataX, chartDatas[i].DataY, chartDatas[i].DescriptionData.Name, chartDatas[i].ColorChart);
                    break;
            }
        }
    }
    ...
    internal void AddChartElement(IChartElement element)
    {
        ...
        if (element is ScatterPlot scatter)
        {
            chartVisual1.AddScatter(
                scatter.Data.GetX(),
                scatter.Data.GetY(),
                scatter.Name,
        ...
        if (element is RadialPlot radial)
        {
            chartVisual1.AddRadialPlot(
                radial.Data.GetX(),
                radial.Data.GetY(),
                radial.Name,
                radial.ElementColor);
    ...
    {
        SKColor c = element.ElementColor;
        AddSpectrum(element.Data.GetX(), element.Data.GetY(), Color.FromArgb(c.Alpha, c.Red, c.Green, c.Blue), element.Name);
    }
    ...
    {
        SKColor c = element.ElementColor;
        AddIntegr(element.Data.GetX(), element.Data.GetY(), Color.FromArgb(c.Alpha, c.Red, c.Green, c.Blue), element.Name, 2);
    }

    internal void AddDiff(IChartElement element)
    {
        SKColor c = element.ElementColor;
        AddDiff(element.Data.GetX(), element.Data.GetY(), Color.FromArgb(c.Alpha, c.Red, c.Green, c.Blue), element.Name, 2);
    }

    internal void AddHistoramm(IChartElement element)
    {
        SKColor c = element.ElementColor;
        AddHistoramm(element.Data.GetY(), Color.FromArgb(c.Alpha, c.Red, c.Green, c.Blue), element.Name);
    }
