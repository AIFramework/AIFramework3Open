...
/// <summary>
/// Алгоритм Форда-Фалкерсона для нахождения максимального потока (BFS — стиль Эдмондса-Карпа)
/// </summary>
[Serializable]
public class FordFulkerson
{
    ...
    /// <summary>
    /// Вычисляет максимальный поток из s в t методом Форда-Фалкерсона (BFS)
    /// </summary>
    ...
    private bool HasAugmentingPath(FlowNetwork network, int s, int t)
    {
