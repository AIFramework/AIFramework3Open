...
/// </summary>
/// <remarks>
/// Упрощение I1: маршрут открывается самым дальним клиентом, а затем вставляется пара
/// «клиент, позиция» с наименьшим приростом длины. Второго критерия I1 — выгоды λ·d(0,u) − c₁ —
/// и учёта сдвига времени в приросте нет; временные окна только проверяются на допустимость.
/// </remarks>
[Serializable]
