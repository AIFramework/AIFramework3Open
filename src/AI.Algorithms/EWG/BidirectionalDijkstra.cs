...
/// </summary>
/// <remarks>
/// Ответ верен, но выигрыша в скорости нет: встреча фиксируется только в вершине, закреплённой
/// обоими поисками, и каждая сторона останавливается, лишь дойдя до радиуса найденного пути μ.
/// Классический критерий — остановка, когда сумма вершин обеих очередей не меньше μ, с обновлением
/// μ при каждой релаксации — здесь не реализован.
/// </remarks>
[Serializable]
