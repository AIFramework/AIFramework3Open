...
namespace AI.BackEnds.DSP.NWaves.Filters
{
    ...
    public class CombFeedbackFilter : IirFilter
    {
        ...
        public CombFeedbackFilter(int m, double b0 = 1.0, double am = 0.6) : base(new float[1], new float[m + 1])
        {
            ...
            // _a и _b — продублированные буферы, обе половины должны совпадать
            _a[0] = _a[_denominatorSize] = 1;
            _a[m] = _a[_denominatorSize + m] = (float)am;
            _b[0] = _b[_numeratorSize] = (float)b0;
        }
        ...
        {
            _b[0] = _b[_numeratorSize] = (float)b0;
            _a[_delay] = _a[_denominatorSize + _delay] = (float)am;
        }
    }
}
