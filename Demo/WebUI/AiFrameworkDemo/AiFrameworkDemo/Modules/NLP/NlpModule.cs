                    ...
                    new AlgoDef("markov_gen", "Марковские цепи (n-граммы)",
                        ...
                        [
                            ...
                            new AlgoParam("_seed", "Начальная фраза", 0, 0, 0, 0, "",
                                "Ровно столько слов, сколько задано в «Размер n-граммы», и они должны встречаться в корпусе подряд. " +
                                "Иначе демо возьмёт начало корпуса и сообщит об этом",
                                TextDefault: "нейронные сети являются"),
                        ]),
                ]),
            #endregion
